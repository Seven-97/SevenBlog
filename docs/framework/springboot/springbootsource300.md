...
head:
  - - meta
    - name: keywords
      content: SpringBoot,核心原理
  - - meta
    - name: description
      content: 全网最全的SpringBoot知识点总结，让天下没有难学的八股文！
---

本文将带你深入了解SpringBoot框架的核心原理，通过300行代码的迷你版本来展示SpringBoot核心注解的作用及特性，在学习本篇文章时，可以同时学习：[深度揭秘SpringBoot自动装配的实现原理](https://www.seven97.top/framework/springboot/principleofautomaticassembly.html)，相信大家会对本文中的各个功能会有更加深刻的理解

本文相关源码请关注：[用300行代码手写SpringBoot核心原理](https://github.com/Seven-97/SpringBoot-Demo/tree/master/A12-springboot-source300)
