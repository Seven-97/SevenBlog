...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921710.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921708.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921716.jpg)

把 mark、sweep、compaction、copying 这几种动作的耗时放在一起看，大致有这样的关系：

![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921718.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921721.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921722.jpg)

#### 2.5.3 常用收集器

目前使用最多的是 CMS 和 G1 收集器，二者都有分代的概念，主要内存结构如下：

![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921499.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921517.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921539.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921559.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921579.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921603.jpg)
...
- MetaSpace 弹性伸缩： 由于 MetaSpace 空间和 Heap 并不在一起，所以这块的空间可以不用设置或者单独设置，一般情况下避免 MetaSpace 耗尽 VM 内存都会设置一个 MaxMetaSpaceSize，在运行过程中，如果实际大小 小于这个值，JVM 就会通过 -XX:MinMetaspaceFreeRatio 和 -XX:MaxMetaspaceFreeRatio 两个参数动态控制整个 MetaSpace 的大小，具体使用可以看 MetaSpaceGC::compute_new_size() 方法（下方代码），这个方法会在 CMSCollector 和 G1CollectorHeap 等几个收集器执行 GC 时调用。这个里面会根据 used_after_gc，MinMetaspaceFreeRatio 和 MaxMetaspaceFreeRatio 这三个值计算出来一个新的 _capacity_until_GC 值（水位线）。然后根据实际的 _capacity_until_GC 值使用 MetaspaceGC::inc_capacity_until_GC() 和 MetaspaceGC::dec_capacity_until_GC() 进行 expand 或 shrink，这个过程也可以参照场景一中的伸缩模型进行理解。
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921448.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921472.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921494.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921514.jpg)

![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921538.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921560.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921158.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921180.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921198.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921221.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921248.jpg)
...
2. 原因二：通过 JNI 调用的 Native Code 申请的内存未释放
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921271.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921924.jpg)

 

最终定位到是，项目中对 GIPInputStream 的使用错误，没有正确的 close()。

![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921948.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921974.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921994.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921020.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921044.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921864.jpg)
...
![image.png](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404251921888.jpg)
