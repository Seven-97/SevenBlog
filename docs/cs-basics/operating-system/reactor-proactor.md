...
![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123181.png)

熟悉的 [select/poll/epoll](https://www.seven97.top/cs-basics/operating-system/selectpollepoll.html) 就是内核提供给用户态的多路复用系统调用，线程可以通过一个系统调用函数从内核中获取多个事件。
...
![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123930.png)
...
![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123192.png)
...
![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123233.png)
...
![阻塞 I/O](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123178.png)

**非阻塞 I/O**，非阻塞的 read 请求在数据未准备好的情况下立即返回，可以继续往下执行，此时应用程序不断轮询内核，直到数据准备好，内核将数据拷贝到应用程序缓冲区，`read` 调用才可以获取到结果。过程如下图：

![非阻塞 I/O](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123168.png)
...
![异步 I/O](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123204.png)
...
![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202406222123940.png)
