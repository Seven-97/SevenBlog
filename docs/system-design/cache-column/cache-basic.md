...
> 缓存系列文章皆来源于：稀土掘金社区[深入理解缓存原理与实战设计](https://juejin.cn/column/7140852038258147358) 及 [小林Coding](https://www.xiaolincoding.com/redis/)，Seven进行了部分补充完善
...
基上面的本地缓存策略改动后重新上线，整体的响应性能上果然提升了很多。**本地缓存**的策略虽然有效地提升了处理请求的速度，*但新的问题也随之浮现*。有用户反馈，社区内的帖子列表多次刷新后会出现内容不一致的情况，有的帖子刷新之后会从列表消失，多次刷新后偶尔会出现。
